...
<body class="bg-gray-100 font-sans">
    ...
    <div class="flex h-screen overflow-hidden">
        ...
        <main class="flex-1 flex flex-col overflow-y-auto">
            ...
            <div class="p-4 md:p-6">
                ...
                <div class="max-w-7xl mx-auto bg-white p-6 rounded-xl shadow" x-data="volunteerTable()" x-init="init()">
    ...
    <script>
    const volunteersFromPHP = <?php echo json_encode($rows, JSON_UNESCAPED_UNICODE | JSON_UNESCAPED_SLASHES); ?>;
    ...
    function volunteerTable() {
        return {
            ...
            init() {
                this.rows = volunteersFromPHP.map(volunteer => {                    
